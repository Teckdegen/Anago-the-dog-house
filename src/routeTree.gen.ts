...
const ClmmIndexRoute = ClmmIndexRouteImport.update({
  id: '/',
  path: '/',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/clmm/': {
      ...
      path: '/'
      fullPath: '/clmm/'
      preLoaderRoute: typeof ClmmIndexRouteImport
