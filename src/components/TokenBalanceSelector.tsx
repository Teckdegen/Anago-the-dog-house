    ...
    <div className={className}>
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12">
            <Coins className="w-5 h-5 mb-2" style={{ color: "rgba(255,255,255,0.6)" }} strokeWidth={1.5} />
            <p className="font-grotesk uppercase text-[12px] tracking-wider" style={{ color: "#FFFFFF" }}>
          ...
          filtered.map((token, i) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 hover:bg-[rgba(139,92,246,0.08)] transition-colors"
                style={{
                  borderBottom: i < filtered.length - 1 ? "1px solid rgba(139,92,246,0.15)" : "none",
              ...
              >
                ...
                <div className="text-right">
                  <p className="font-grotesk text-[13px] tabular-nums" style={{ color: "rgba(255,255,255,0.9)" }}>
                    {token.balanceFormatted}
                  </p>
                  <p className="font-mono text-[9px]" style={{ color: "rgba(255,255,255,0.5)" }}>
                    {usd ?? "Balance"}
                  </p>
                </div>
              </button>
      ...
      {!isLoading && balances.length > 0 && (
        <p className="font-mono text-[9px] mt-2 text-center" style={{ color: "rgba(255,255,255,0.45)" }}>
