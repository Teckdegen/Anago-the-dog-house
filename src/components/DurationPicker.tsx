    ...
    <div>
        ...
        {PRESETS.map((p) => {
          ...
          return (
            <button
              ...
              style={{
                background: active ? "rgba(139,92,246,0.35)" : "rgba(139,92,246,0.07)",
      ...
      >
        <input
          ...
          className="bg-transparent font-mono text-[12px] outline-none w-full px-3 py-2.5 placeholder:text-[rgba(139,92,246,0.35)]"
          style={{ color: "#FFFFFF" }}
        />
        <div className="flex" style={{ borderLeft: "1px solid rgba(139,92,246,0.2)" }}>
          {UNITS.map((u) => {
